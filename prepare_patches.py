...
"""
import argparse
from dataset_3d import prepare_data
...
if __name__ == "__main__":
	...
	parser.add_argument("--patch_size", "--p", type=int, default=24, \
					 help="Patch size")
	...
	if args.gray:
		if args.trainset_dir is None:
			args.trainset_dir = 'data/gray_d/train'
		if args.valset_dir is None:
			args.valset_dir = 'data/gray_d/val'
	else:
		if args.trainset_dir is None:
